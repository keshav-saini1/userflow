                  ...
                  <div className="absolute top-3.5 right-3.5">
                     ...
                     >
                        <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none">
                           <path d="M20.84 4.61C20.3292 4.099 19.7228 3.69364 19.0554 3.41708C18.3879 3.14052 17.6725 2.99817 16.95 2.99817C16.2275 2.99817 15.5121 3.14052 14.8446 3.41708C14.1772 3.69364 13.5708 4.099 13.06 4.61L12 5.67L10.94 4.61C9.9083 3.5783 8.50903 2.9987 7.05 2.9987C5.59096 2.9987 4.19169 3.5783 3.16 4.61C2.1283 5.6417 1.5487 7.04097 1.5487 8.5C1.5487 9.95903 2.1283 11.3583 3.16 12.39L12 21.23L20.84 12.39C21.351 11.8792 21.7564 11.2728 22.0329 10.6054C22.3095 9.93789 22.4518 9.22249 22.4518 8.5C22.4518 7.77751 22.3095 7.0621 22.0329 6.39464C21.7564 5.72718 21.351 5.12075 20.84 4.61Z" stroke="#FB2C36" strokeWidth="1.46" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                     </button>
                  </div>
               )}
            ...
            <div className="flex flex-col gap-2.5 px-3.5 lg:px-6 py-0 order-1">
               {property.status === 'booked' ? (
                  <div className="flex justify-center h-[37.5px] lg:h-12">
                     ...
                     >
                        <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none">
                           <path d="M3 3H21V21H3V3Z" stroke="#4a5565" strokeWidth="1.46" strokeLinecap="round" strokeLinejoin="round"/>
                           <path d="M3 9H21" stroke="#4a5565" strokeWidth="1.46" strokeLinecap="round" strokeLinejoin="round"/>
                           <path d="M9 21V9" stroke="#4a5565" strokeWidth="1.46" strokeLinecap="round" strokeLinejoin="round"/>
                           <path d="M15 21V9" stroke="#4a5565" strokeWidth="1.46" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
