...
import callGreen from '@/assets/property/call_green.svg';
import chat from '@/assets/property/chat.svg';
...
export const LocationSection: React.FC<LocationSectionProps> = ({ 
  ...
  return (
    <div className="flex flex-col gap-3.5">
      ...
      {/* Assistance Card */}
      <div className="bg-blue-50 rounded-[14px] p-[22px] relative border border-[#bedbff]">
        <div className="flex flex-col gap-3.5">
          {/* Header */}
          <div className="flex flex-col">
            <h3 className="text-[#1c398e] text-[15.8px] font-semibold leading-[24.5px]">
              Need assistance?
            </h3>
          </div>
          ...
          <div className="flex gap-[10.5px]">
            ...
            <button 
              onClick={onChatClick}
              className="bg-white rounded-[12.75px] px-[26px] py-[10.5px] flex items-center gap-[7px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]"
            >
              <img src={chat} alt="chat" className="w-[17.5px] h-[17.5px]" />
              <span className="text-[#101828] text-[14px] font-medium leading-[21px] whitespace-nowrap">
                Chat Support
              </span>
            </button>
            ...
            <button 
              onClick={onCallClick}
              className="bg-white rounded-[12.75px] px-[47px] py-[10.5px] flex items-center gap-[7px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]"
            >
              <img src={callGreen} alt="call" className="w-[17.5px] h-[17.5px]" />
              <span className="text-[#101828] text-[14px] font-medium leading-[21px] whitespace-nowrap">
                Call Us
              </span>
            </button>
