...
import private_im from "@/assets/property/private.svg";
import ac from "@/assets/property/ac.svg";
import wifi_bw from "@/assets/property/wifi_bw.svg";
import gym from "@/assets/property/gym.svg";
import wifi_img from '@/assets/property/wifi_img.svg'
import iron from '@/assets/property/ironing.svg'
...
export const samplePropertyDetailData = {
   ...
   description:
      "This is a spacious double sharing room located in a corner unit, featuring a master bedroom layout that offers privacy and comfort...",
   ...
   addOnServices: [
      { id: "gym", name: "Gym", price: "₹1,800/Monthly", image: gym },
      { id: "wifi", name: "WiFi", price: "₹470/Monthly", image: wifi_img },
      { id: "ironing", name: "Ironing", price: "₹200/Monthly", image: iron },
   ],
   location: {
      area: "Iffco Chowk",
      city: "Gurgaon",
   ...
   policies: [
      ...
      {
         id: "no-opposite-gender",
         rule: "Opposite gender guests are not allowed",
      },
      { id: "no-smoking", rule: "Smoking is strictly prohibited" },
   ],
   marketingDescription:
      "This is a spacious double sharing room located in a corner unit, featuring a master bedroom layout that offers privacy and comfort. Perfectly suited for families and working professionals seeking a comfortable living space.",
};
