    ...
    <div className="min-h-screen bg-white w-screen pb-20">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-100">
        <div className="flex items-center justify-between p-4 sm:p-5 lg:p-6">
          ...
          <button 
            onClick={onDone}
            className="w-8 h-8 sm:w-[35px] sm:h-[35px] bg-gray-100 rounded-full flex items-center justify-center"
          >
      ...
      <div className="px-4 sm:px-5 lg:px-6 pt-4 sm:pt-7 pb-20 sm:pb-24 w-full overflow-hidden max-w-4xl mx-auto">
        <div className="flex flex-col gap-6 sm:gap-7">
          ...
          <div className="flex flex-col items-center gap-4 sm:gap-5">
            <div className="w-16 h-16 sm:w-[70px] sm:h-[70px] bg-green-100 rounded-full flex items-center justify-center">
              <img
                src={successIcon}
                alt="Success"
            ...
            <div className="text-center">
              ...
              <p className="text-sm sm:text-[15.8px] text-[#4a5565] leading-tight sm:leading-[25.59px]">
                Your visit has been confirmed for {bookingDetails.property}.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[21px] border border-gray-100 shadow-sm overflow-hidden">
            <div className="relative h-32 sm:h-[156px] bg-gradient-to-br from-blue-500 to-purple-600">
          ...
          <div className="bg-gray-50 rounded-[14px] p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-4 h-4 sm:w-[17.5px] sm:h-[17.5px] text-blue-600">
                📋
              </div>
          ...
          <div className="bg-blue-50 rounded-[14px] p-4 sm:p-5">
            ...
            <div className="space-y-3">
              <div className="flex gap-2.5">
                <div className="w-5 h-5 sm:w-[21px] sm:h-[21px] bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <div className="w-3 h-3 sm:w-[12.25px] sm:h-[12.25px] text-blue-600 text-xs">✓</div>
                </div>
                <div>
