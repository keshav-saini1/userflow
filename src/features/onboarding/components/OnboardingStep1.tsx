        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 lg:p-8">
          <div className="max-w-4xl mx-auto">
            <div className="mb-4 lg:mb-6 text-left lg:text-center">
              <span className="text-white text-xl lg:text-3xl font-bold mb-3 lg:mb-4 tracking-tight">
              ...
              <div className="flex items-center mb-3 lg:mb-4 lg:justify-center">
                ...
                <span className="text-white/90 text-sm lg:text-base font-medium">Iffco Chowk, Gurgaon</span>
              </div>
              
              {/* Commute times card */}
              <div className="backdrop-blur-md bg-white/10 p-3 lg:p-4 rounded-xl border border-white/20 max-w-2xl lg:mx-auto">
                <div className="flex items-center justify-start lg:justify-center mb-2">
                  ...
                  <svg className="w-3 h-3 lg:w-4 lg:h-4 text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </div>
                <p className="text-white/70 text-xs lg:text-sm">Tap to explore commute times</p>
              </div>
              ...
              <div className="flex flex-wrap gap-2 lg:gap-3 mt-3 lg:mt-4 lg:justify-center">
                <div className="backdrop-blur-md bg-white/15 px-3 py-1 lg:px-4 lg:py-2 rounded-full flex items-center space-x-2">
                  ...
                  <span className="text-white text-xs lg:text-sm font-medium">Verified</span>
                  <span className="text-white/70 text-xs lg:text-sm">Properties</span>
                </div>
                <div className="backdrop-blur-md bg-white/15 px-3 py-1 lg:px-4 lg:py-2 rounded-full flex items-center space-x-2">
                  <div className="w-3 h-3 lg:w-4 lg:h-4 bg-blue-500 rounded"></div>
                  <span className="text-white text-xs lg:text-sm font-medium">Move-in</span>
                  <span className="text-white/70 text-xs lg:text-sm">Ready</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-6 lg:mb-12">
            ...
            <p className="text-gray-600 text-sm lg:text-lg leading-relaxed max-w-2xl mx-auto">
              Move in, make friends, start living. We'll take care of everything else.
            </p>
          </div>
          ...
          <div className="space-y-3 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-6 xl:gap-8">
            ...
            <div className="bg-white p-4 lg:p-6 rounded-xl shadow-sm border border-gray-100 lg:shadow-md hover:shadow-lg transition-shadow">
              <div className="flex space-x-3 lg:space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-gray-900 text-sm lg:text-lg mb-1 lg:mb-2">Your room, your sanctuary</h3>
                  <p className="text-gray-600 text-xs lg:text-sm leading-relaxed">
                    Walk into a fully furnished room that's ready for your first Instagram story. 
                    No shopping lists, no setup stress.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 lg:p-6 rounded-xl shadow-sm border border-gray-100 lg:shadow-md hover:shadow-lg transition-shadow">
              <div className="flex space-x-3 lg:space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-gray-900 text-sm lg:text-lg mb-1 lg:mb-2">Meet your new crew</h3>
                  <p className="text-gray-600 text-xs lg:text-sm leading-relaxed">
                    From morning coffee chats to weekend adventures, you're moving into 
                    friendships that might just change your life.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 lg:p-6 rounded-xl shadow-sm border border-gray-100 lg:shadow-md hover:shadow-lg transition-shadow">
              <div className="flex space-x-3 lg:space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-gray-900 text-sm lg:text-lg mb-1 lg:mb-2">Zero adulting required</h3>
                  <p className="text-gray-600 text-xs lg:text-sm leading-relaxed">
                    WiFi that actually works, cleaning that happens like magic, 
                    and bills that pay themselves. You focus on living.
                  </p>
                </div>
              </div>
            </div>
